class Solution {
    public void dfs(String node, String dest, HashMap<String,
    HashMap<String, Double>> gr, HashSet<String> vis, double[] ans, double temp)
    {
    ...
    buildGraph(List<List<String>> equations, double[] values) {
    ...
    values, List<List<String>> queries) {
        ...
        HashMap<String, HashMap<String, Double>> gr = buildGraph(equations,
